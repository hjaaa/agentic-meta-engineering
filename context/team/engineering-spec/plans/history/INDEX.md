...
| PR4 | CI 升 strict + 历史治理：legacy 字段实现（meta-schema optional + check_reviews 短路）+ REQ-2026-001 标 legacy: true + CI workflow Check reviews step 加 --strict + roadmap G3 标 ✅ done + C5→C4 触发信号沉淀 + REQ-2099-300/400 sandbox 三态正反例通过 | [reviewer-verdict-pr4-strict-and-governance](./2026-04-27-reviewer-verdict-pr4-strict-and-governance.md) | `feat/reviewer-verdict-pr4-strict-and-governance` | ✅ 已合入（PR #42） |
