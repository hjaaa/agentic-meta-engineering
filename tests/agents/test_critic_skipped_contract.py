...
class TestCriticSkippedContract:
    ...
    def should_satisfy_invariant_i7(self):
    ...
    def should_satisfy_invariant_i8(self):
    ...
    def should_use_trivial_reason_template(self):
    ...
    def should_contain_all_eight_checker_names(self):
