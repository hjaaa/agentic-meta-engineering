"""tests for scripts/lib/context_usage_report.py（F-004 验收测试）。

覆盖 ContextInventory.scan 的 5 条验收标准（F-004.md §验收标准）：
...
from context_usage_report import ContextInventory, KnowledgeFile  # noqa: E402
