...
AC-9/10/11 fail-closed 回归三测试已抽出到 test_poll_subworkflows_fail_closed.py
（IB-35：避免本文件越 complexity-checker 阈值 500 行）。
...
# AC-9 / AC-10 / AC-11 fail-closed 回归三测试已抽出到 test_poll_subworkflows_fail_closed.py
# （IB-35：拆分避免本文件越 complexity-checker 阈值 500 行）
